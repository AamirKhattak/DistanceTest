...
public class AndroidCamera extends Activity implements SensorEventListener, SurfaceHolder.Callback
{
...
*/
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (event.sensor.getType() == Sensor.TYPE_ORIENTATION) {
            ...
            String outfloat = String.format("Current Height[%.1f] inches\nCurrent Azimuth[%.2f] degrees\nCurrent Pitch[%.2f] degrees\nCurrent Roll[%.2f] degrees\nCurrent Distance[%.2f] inches"
